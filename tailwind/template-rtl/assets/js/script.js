				...
				'<div class="sidebar-body">' +
					...
					'<div class="switch-wrapper">' +
						'<div id="dark-mode-toggle">' +
							'<span class="light-mode active"> <img src="assets/img/icons/sun-icon.svg" class="ml-2" alt=""> Light</span>' +
							'<span class="dark-mode"><i class="far fa-moon ml-2"></i> Dark</span>' +
						'</div>' +
					'</div>' +
						...
						'<div class="ere">' +
							'<div class="layout-wrap">' +								
								'<div class="flex items-center">' +
									'<div class="status-toggle flex items-center ml-2">' +
										'<input type="checkbox" id="1" class="check">' +
										'<label for="1" class="checktoggle"><a href="../template/index.html" class="layout-link">checkbox</a> </label>' + 
									'</div>' +
