      ...
      <div class="page-header">
        ...
        <div class="page-btn">
          <a
            ...
            ><vue-feather type="plus-circle" class="ms-2"></vue-feather>Add New
            Attendance</a
          >
        </div>
      </div>
        ...
        <div class="card-body pb-0">
          <div class="table-top">
            ...
            <div class="form-sort">
              ...
              <vue-select :options="SortAtte" id="sortatte" placeholder="Sort by Date" />
            </div>
          </div>
          <!-- /Filter -->
          <div
                ...
                <tr>
                  ...
                  <td>
                    <div class="input-blocks leave-table">
                      <vue-select :options="Approve" id="approve" placeholder="Approve" />
                    </div>
                  </td>
                  <td class="action-table-data">
                    <div class="edit-delete-action">
