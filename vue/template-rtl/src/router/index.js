...
import Users from '@/views/pages/users/ui-users.vue'
...
import Permissions from '@/views/pages/users/user-permissions.vue'
...
import Payslip from '@/views/pages/hrm/payroll/pos-payslip.vue'
...
import Payroll from '@/views/pages/hrm/payroll/pos-payroll.vue'
const routes = [
  {
    path: '/',
    name: 'sign-in',
