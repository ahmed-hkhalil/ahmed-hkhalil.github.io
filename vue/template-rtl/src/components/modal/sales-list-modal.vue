												...
												<div class="input-blocks">
													...
													<div class="row">
														...
														<div class="col-lg-2 col-sm-2 col-2 ps-0">
															<div class="add-icon">
																<a href="javascript:void(0);" class="choose-add"><vue-feather type="plus-circle" class="plus"></vue-feather></a>
															</div>
														</div>
													</div>
												</div>
						...
						<div class="content p-0">
							<div class="page-header p-4 mb-0">
								<div class="add-item d-flex">
									...
									<div class="page-btn">
										<a href="javascript:void(0);" class="btn btn-added"><vue-feather type="plus-circle" class="me-2"></vue-feather> Add New Sales</a>
									</div>
								</div>
								<ul class="table-top-head">
									<li>
										<a data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf"><vue-feather type="edit" class="action-edit sales-action"></vue-feather></a>
									</li>
									<li>
									...
									<li>
										<a data-bs-toggle="tooltip" data-bs-placement="top" title="Print"><vue-feather type="printer" class="feather-rotate-ccw"></vue-feather></a>
									</li>
								</ul>
							</div>
														...
														<tr>
															...
															<td>
																<div class="product-quantity">
																	<span class="quantity-btn">+<vue-feather type="plus-circle" class="plus-circle"></vue-feather></span>
																	<input type="text" class="quntity-input" value="2">
																	<span class="quantity-btn"><vue-feather type="minus-circle" class="search"></vue-feather></span>
																</div>
															</td>
															<td>2000</td>
															<td>500</td>
														...
														<tr>
															...
															<td class="action-table-data">
																<div class="edit-delete-action">
																	...
																	<a class="me-3 p-2" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#editpayment">
																		<vue-feather type="edit" class="feather-edit"></vue-feather>
																	</a>
																	<a class="confirm-text p-2" href="javascript:void(0);" @click="showConfirmation">
