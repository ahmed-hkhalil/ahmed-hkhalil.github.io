                        ...
                        <div class="product-wrap">
                            <div class="product-list d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center flex-fill">
                                    <a href="javascript:void(0);" class="img-bg ms-2">
                ...
                <div class="modal-body">
                    <form @submit.prevent="submitForm">
                        ...
                        <div class="modal-footer d-sm-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-submit ms-2">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="action-table-data">
                                                    <div class="edit-delete-action">
                                                        <a class="ms-2 p-2" href="javascript:void(0);"><vue-feather type="eye"
                                                                class="feather-eye"></vue-feather></a>
                                                        <a class="ms-2 p-2" href="javascript:void(0);"><vue-feather
