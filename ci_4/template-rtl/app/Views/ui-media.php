                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-start text-muted mb-4">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="<?php echo base_url(); ?>/assets/img/users/user-5.jpg"
                                    ...
                                    <div class="d-flex align-items-start text-muted mb-4">
                                        ...
                                        <div class="flex-shrink-0 ms-3">
                                            <img src="<?php echo base_url(); ?>/assets/img/users/user-6.jpg"
                                                class="avatar avatar-xl rounded" alt="...">
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-start text-muted">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="<?php echo base_url(); ?>/assets/img/users/user-7.jpg"
                                                class="avatar avatar-xl rounded" alt="...">
                                        </div>
                                        <div class="flex-grow-1">
                                            <h5 class="fs-14">Media Heading</h5>
