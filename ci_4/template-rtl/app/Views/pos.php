										...
										<ul class="tabs owl-carousel pos-category">
											<li id="all">
												<a href="javascript:void(0);">
													<img src="<?php echo base_url(); ?>/assets/img/categories/category-01.png" alt="Categories">
												</a>
											...
											<li id="headphones">
												<a href="javascript:void(0);">
													<img src="<?php echo base_url(); ?>/assets/img/categories/category-02.png" alt="Categories">
												</a>
											...
											<li id="shoes">
												<a href="javascript:void(0);">
													<img src="<?php echo base_url(); ?>/assets/img/categories/category-03.png" alt="Categories">
												</a>
											...
											<li id="mobiles">
												<a href="javascript:void(0);">
													<img src="<?php echo base_url(); ?>/assets/img/categories/category-04.png" alt="Categories">
												</a>
											...
											<li id="watches">
												<a href="javascript:void(0);">
													<img src="<?php echo base_url(); ?>/assets/img/categories/category-05.png" alt="Categories">
												</a>
											...
											<li id="laptops">
												<a href="javascript:void(0);">
													<img src="<?php echo base_url(); ?>/assets/img/categories/category-06.png" alt="Categories">
												</a>
												...
												<div  class="tab_content active" data-tab="all">
													<div class="row">
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-01.png" alt="Products">
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-02.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-03.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-04.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-05.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-06.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
																<h6 class="cat-name"><a href="javascript:void(0);">Shoes</a></h6>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-07.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-08.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
																<h6 class="cat-name"><a href="javascript:void(0);">Headphones</a></h6>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-09.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
																<h6 class="cat-name"><a href="javascript:void(0);">Watches</a></h6>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-10.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
																<h6 class="cat-name"><a href="javascript:void(0);">Computer</a></h6>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-11.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
																<h6 class="cat-name"><a href="javascript:void(0);">Watches</a></h6>
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-18.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
																<h6 class="cat-name"><a href="javascript:void(0);">Shoes</a></h6>
												...
												<div  class="tab_content" data-tab="mobiles">
													<div class="row">
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-14.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
																<h6 class="cat-name"><a href="javascript:void(0);">Mobiles</a></h6>
												...
												<div  class="tab_content" data-tab="laptops">
													<div class="row">
														...
														<div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
															<div class="product-info default-cover card">
																<a href="javascript:void(0);" class="img-bg">
																	<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-13.png" alt="Products">
																	<span><i data-feather="check" class="feather-16"></i></span>
																</a>
																<h6 class="cat-name"><a href="javascript:void(0);">Laptop</a></h6>
											...
											<div class="product-wrap">
												<div class="product-list d-flex align-items-center justify-content-between">
													<div class="d-flex align-items-center product-info" data-bs-toggle="modal" data-bs-target="#products">
														<a href="javascript:void(0);" class="img-bg">
															<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-16.png" alt="Products">
														</a>
														<div class="info">
															<span>PT0005</span>
												...
												<div class="product-list d-flex align-items-center justify-content-between">
													<div class="d-flex align-items-center product-info" data-bs-toggle="modal" data-bs-target="#products">
														<a href="javascript:void(0);" class="img-bg">
															<img src="<?php echo base_url(); ?>/assets/img/products/pos-product-17.png" alt="Products">
														</a>
														<div class="info">
															<span>PT0235</span>
											...
											<div class="row d-flex align-items-center justify-content-center methods">
												<div class="col-md-6 col-lg-4 item">
													<div class="default-cover">
														<a href="javascript:void(0);">
															<img src="<?php echo base_url(); ?>/assets/img/icons/cash-pay.svg" alt="Payment Method">
															<span>Cash</span>
														</a>
													</div>
												</div>
												<div class="col-md-6 col-lg-4 item">
													<div class="default-cover">
														<a href="javascript:void(0);">
															<img src="<?php echo base_url(); ?>/assets/img/icons/credit-card.svg" alt="Payment Method">
												...
												<div class="col-md-6 col-lg-4 item">
													<div class="default-cover">
														<a href="javascript:void(0);">
															<img src="<?php echo base_url(); ?>/assets/img/icons/qr-scan.svg" alt="Payment Method">
															<span>Scan</span>
														</a>
													</div>
												</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="icon-head text-center">
							<a href="javascript:void(0);">
								<img src="<?php echo base_url(); ?>/assets/img/logo.png" width="100" height="30" alt="Receipt Logo">
							</a>
						</div>
						...
						<div class="text-center invoice-bar">
							...
							<a href="javascript:void(0);">
								<img src="<?php echo base_url(); ?>/assets/img/barcode/barcode-03.jpg" alt="Barcode">
							</a>
							<p>Sale 31</p>
									...
									<div class="table-top">
										<div class="search-set">
											<div class="search-input">
												<a class="btn btn-searchset d-flex align-items-center h-100"><img src="<?php echo base_url(); ?>/assets/img/icons/search-white.svg" alt="img"></a>
											</div>
										</div>
										<div class="wordset">
											<ul>
												<li>
													<a class="d-flex align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf"><img src="<?php echo base_url(); ?>/assets/img/icons/pdf.svg" alt="img"></a>
												</li>
												<li>
													<a class="d-flex align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-placement="top" title="Excel"><img src="<?php echo base_url(); ?>/assets/img/icons/excel.svg" alt="img"></a>
												</li>
												<li>
								...
								<div class="tab-pane fade" id="return" role="tabpanel" >
									<div class="table-top">
										...
										<div class="wordset">
											<ul>
												<li>
													<a data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf" class="d-flex align-items-center justify-content-center"><img src="<?php echo base_url(); ?>/assets/img/icons/pdf.svg" alt="img"></a>
												</li>
												<li>
													<a data-bs-toggle="tooltip" data-bs-placement="top" title="Excel" class="d-flex align-items-center justify-content-center"><img src="<?php echo base_url(); ?>/assets/img/icons/excel.svg" alt="img"></a>
												</li>
												<li>
