						...
						<div class="content settings-content">
							...
							<div class="row">
								<div class="col-xl-12">
									...
									<?= $this->include('partials/settings-sidebar') ?>
															...
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-01.svg" alt="Payment">
																		</span>
																	</div>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-02.svg" alt="Payment">
																		</span>
																	</div>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-03.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn not-connect">
																		<a href="javascript:void(0);">Not connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-04.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn not-connect">
																		<a href="javascript:void(0);">Not connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-05.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn">
																		<a href="javascript:void(0);">Connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-06.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn not-connect">
																		<a href="javascript:void(0);">Not connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-07.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn">
																		<a href="javascript:void(0);">Connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-08.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn not-connect">
																		<a href="javascript:void(0);">Not connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-09.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn not-connect">
																		<a href="javascript:void(0);">Not connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-10.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn not-connect">
																		<a href="javascript:void(0);">Not connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-11.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn">
																		<a href="javascript:void(0);">Connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-12.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn not-connect">
																		<a href="javascript:void(0);">Not connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-13.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn not-connect">
																		<a href="javascript:void(0);">Not connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-14.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn">
																		<a href="javascript:void(0);">Connected</a>
														...
														<ul class="w-100">
															<li class="flex-column align-items-start">
																<div class="d-flex align-items-center justify-content-between w-100 mb-2">
																	<div class="security-type d-flex align-items-center">
																		<span>
																			<img src="<?php echo base_url(); ?>/assets/img/icons/payment-icon-15.svg" alt="Payment">
																		</span>
																	</div>
																	<div class="connect-btn not-connect">
																		<a href="javascript:void(0);">Not connected</a>
