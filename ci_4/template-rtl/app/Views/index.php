						...
						<div class="row">
							...
							<div class="col-xl-3 col-sm-6 col-12 d-flex">
								<div class="dash-count das2">
									...
									<div class="dash-imgs">
										<img src="<?php echo base_url(); ?>/assets/img/icons/file-text-icon-01.svg" class="img-fluid" alt="icon">
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-sm-6 col-12 d-flex">
												...
												<tbody>
													<tr>
														...
														<td class="productimgname">
															...
															<a href="<?php echo base_url(); ?>product-list">Lenevo 3rd Generation</a>
														</td>
														<td>$12500</td>
													</tr>
													<tr>
