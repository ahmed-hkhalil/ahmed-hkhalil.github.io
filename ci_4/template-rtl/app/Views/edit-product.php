			...
			<div class="content">
				<div class="page-header">
					...
					<ul class="table-top-head">
						<li>
							<div class="page-btn">
								<a href="<?php echo base_url();?>product-list" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Product</a>
							</div>
						</li>
						<li>
				...
				<!-- /add -->
				<form action="<?php echo base_url();?>edit-product">
					<div class="card">
					...
					<div class="content">
						...
						<div class="modal-body custom-modal-body">
							...
							<div class="modal-footer-btn">
								<a href="javascript:void(0);" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</a>
								<a href="<?php echo base_url();?>add-product" class="btn btn-submit">Submit</a>
							</div>
						</div>
					</div>
				</div>
