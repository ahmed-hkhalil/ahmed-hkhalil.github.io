                                    ...
                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <img class="d-block img-fluid" src="<?php echo base_url(); ?>/assets/img/img-1.jpg"
                                                    alt="First slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block img-fluid" src="<?php echo base_url(); ?>/assets/img/img-3.jpg"
                                                    alt="Second slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block img-fluid" src="<?php echo base_url(); ?>/assets/img/img-4.jpg"
                                                    alt="Third slide">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner" role="listbox">
                                            ...
                                            <div class="carousel-item">
                                                <img class="d-block img-fluid" src="<?php echo base_url(); ?>/assets/img/img-2.jpg"
                                                    alt="Second slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block img-fluid" src="<?php echo base_url(); ?>/assets/img/img-4.jpg"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <img src="<?php echo base_url(); ?>/assets/img/img-1.jpg" alt="Slide"
                                            ...
                                            <div class="carousel-item">
                                                <img src="<?php echo base_url(); ?>/assets/img/img-2.jpg" alt="Slide"
                                                    class="d-block img-fluid">
                                                <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <div class="carousel-item">
                                                <img src="<?php echo base_url(); ?>/assets/img/img-3.jpg" alt="Slide"
                                                    class="d-block img-fluid">
                                                <div class="carousel-caption d-none d-md-block">
