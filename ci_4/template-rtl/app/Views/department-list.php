							...
							<div class="table-top table-top-new">
								...
								<div class="search-path d-flex align-items-center search-path-new">
									<div class="d-flex">
										...
										<a href="<?php echo base_url();?>department-list" class="btn-list active"><i data-feather="list" class="feather-user"></i></a>
										<a href="<?php echo base_url();?>department-grid" class="btn-grid"><i data-feather="grid" class="feather-user"></i></a>
									</div>
									<div class="form-sort">
					...
					<div class="page-wrapper-new p-0">
						<div class="content">
							...
							<div class="modal-body custom-modal-body">
								<form action="<?php echo base_url();?>department-list">
									<div class="row">
										<div class="col-lg-12">
											<div class="mb-3">
