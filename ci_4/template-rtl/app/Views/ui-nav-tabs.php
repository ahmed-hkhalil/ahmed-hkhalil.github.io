                                                ...
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row">
                                                                <span class="avatar avatar-sm">
                                                                    <img src="<?php echo base_url(); ?>/assets/img/products/product49.jpg"
                                                                        alt="img">
                                                                </span>
                                                            </th>
                                                            <td>Wrist Watch</td>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <span class="avatar avatar-sm">
                                                                    <img src="<?php echo base_url(); ?>/assets/img/products/product28.jpg"
                                                                        alt="img">
                                                                </span>
                                                            </th>
                                                            <td>Camera</td>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <span class="avatar avatar-sm">
                                                                    <img src="<?php echo base_url(); ?>/assets/img/products/product60.jpg"
                                                                        alt="img">
                                                                </span>
                                                            </th>
                                                            <td>Shoes</td>
