                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xl-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <img src="<?php echo base_url(); ?>/assets/img/img-4.jpg" alt="image"
                                                ...
                                                <div class="col-sm-3">
                                                    <img src="<?php echo base_url(); ?>/assets/img/profiles/avatar-03.jpg" alt="image"
                                                ...
                                                <div class="col-sm-3">
                                                    <img src="<?php echo base_url(); ?>/assets/img/img-1.jpg" alt="image"
                                                ...
                                                <div class="col-sm-3">
                                                    <img src="<?php echo base_url(); ?>/assets/img/profiles/avatar-02.jpg" alt="image"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <img class="rounded float-start" src="<?php echo base_url(); ?>/assets/img/img-1.jpg" alt="..."
                                        width="200">
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <img class="rounded mx-auto d-block" src="<?php echo base_url(); ?>/assets/img/img-1.jpg"
                                        alt="..." width="200">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <img class="rounded float-end" src="<?php echo base_url(); ?>/assets/img/img-1.jpg" alt="..."
                                        width="200">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body d-flex justify-content-between gap-2">
                                    <figure class="figure">
                                        <img class="bd-placeholder-img figure-img img-fluid rounded card-img"
                                            src="<?php echo base_url(); ?>/assets/img/img-1.jpg" alt="...">
