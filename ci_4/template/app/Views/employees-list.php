							...
							<div class="table-top table-top-two table-top-new">
								...
								<div class="search-path d-flex align-items-center search-path-new">
									<div class="d-flex">
										...
										<a href="<?php echo base_url();?>employees-list" class="btn-list active"><i data-feather="list" class="feather-user"></i></a>
										<a href="<?php echo base_url();?>employees-grid" class="btn-grid"><i data-feather="grid" class="feather-user"></i></a>
									</div>
									<div class="form-sort">
										...
										<tr>
											...
											<td class="action-table-data">
												<div class="edit-delete-action">
													...
													<a class="me-2 p-2" href="<?php echo base_url();?>edit-employee">
