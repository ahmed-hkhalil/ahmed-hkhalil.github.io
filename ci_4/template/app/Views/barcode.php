                                            ...
                                            <div class="col-sm-4">
                                                <div class="barcode-scanner-link text-center">
                                                    ...
                                                    <div class="barscaner-img">
                                                        <img src="<?php echo base_url(); ?>./assets/img/barcode/barcode-01.png" alt="Barcode" class="img-fluid">
                                                    </div>                                           
                                                </div>                                                
                                            </div>
                                        </div>   
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="barcode-scanner-link text-center">
                                                    ...
                                                    <p>Price: $300</p> 
                                                    <div class="barscaner-img">
                                                        <img src="<?php echo base_url(); ?>./assets/img/barcode/barcode-02.png" alt="Barcode" class="img-fluid">
                                                    </div>                                           
                                                </div>                                                
                                            </div>
                                            <div class="col-sm-4">
