        ...
        <div class="main-wrapper">
            <div class="account-content">
                        <div class="login-wrapper">
                            <div class="login-content">
                                <form action="signin-2">
                                    ...
                                    <div class="signinform">
                                        <h4>Already have an account ? <a href="<?php echo base_url(); ?>signin-2" class="hover-a">Sign In Instead</a></h4>
                                    </div>
                            ...
                            <div class="login-img">
                                <img src="<?php echo base_url(); ?>/assets/img/authentication/register02.png" alt="img">
                            </div>
                        </div>
            </div>
        </div>
