                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-12">
                            ...
                            <div class="row row-cols-12">
                                <div class="col">
                                    <div class="card">
                                        <div class="card-body">
                                            <img src="<?php echo base_url(); ?>/assets/img/img-04.jpg" class="card-img mb-3"
                                                alt="...">
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-body">
                                            <img src="<?php echo base_url(); ?>/assets/img/img-05.jpg" class="card-img mb-3"
                                                alt="...">
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-body">
                                            <img src="<?php echo base_url(); ?>/assets/img/img-02.jpg" class="card-img mb-3"
                                                alt="...">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-sm avatar-rounded me-2">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-2.jpg" alt="img">
                                        </span>
                            ...
                            <div class="card text-center">
                                ...
                                <div class="card-body pt-1">
                                    <span class="avatar avatar-xl avatar-rounded me-2 mb-2">
                                        <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-7.jpg" alt="img">
                                    </span>
                                    ...
                                    <div class="d-flex w-100">
                                        <div class="me-4">
                                            <span class="avatar avatar-lg avatar-rounded">
                                                <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-3.jpg" alt="img">
                                            </span>
                                        </div>
                            ...
                            <div class="card card-bg-danger">
                                <div class="card-body">
                                    <div class="d-flex align-items-center w-100">
                                        <div class="me-2">
                                            <span class="avatar avatar-rounded">
                                                <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-4.jpg" alt="img">
                                            </span>
                                        </div>
                                        <div class="">
                            ...
                            <div class="card card-bg-light">
                                <div class="card-body">
                                    <div class="d-flex align-items-center w-100">
                                        <div class="me-2">
                                            <span class="avatar avatar-rounded">
                                                <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-5.jpg" alt="img">
                                            </span>
                                        </div>
                                        <div class="">
                            ...
                            <div class="card card-bg-dark">
                                <div class="card-body">
                                    <div class="d-flex align-items-center w-100">
                                        <div class="me-2">
                                            <span class="avatar avatar-rounded">
                                                <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-6.jpg" alt="img">
                                            </span>
                                        </div>
                                        <div class="">
                            ...
                            <div class="card border border-warning">
                                <div class="card-body">
                                    ...
                                    <div class="avatar-list-stacked">
                                        ...
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-8.jpg" alt="img">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-9.jpg" alt="img">
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border border-info">
                                <div class="card-body">
                                    ...
                                    <div class="avatar-list-stacked">
                                        ...
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-12.jpg" alt="img">
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3">
                            <div class="card border border-danger">
                                <div class="card-body">
                                    ...
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-13.jpg" alt="img">
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3">
                            <div class="card border border-success">
                                <div class="card-body">
                                    ...
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-14.jpg" alt="img">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-15.jpg" alt="img">
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3">
                            <div class="card border border-light">
                                <div class="card-body">
                                    ...
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-16.jpg" alt="img">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-17.jpg" alt="img">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="<?php echo base_url(); ?>/assets/img/avatar/avatar-18.jpg" alt="img">
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xxl-7 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-4">
                                                <img src="<?php echo base_url(); ?>/assets/img/img-5.jpg"
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="row row-cols-1 row-cols-md-4 g-4">
                                <div class="col">
                                    <div class="card">
                                        <img src="<?php echo base_url(); ?>/assets/img/img-01.jpg" class="card-img-top"
                                            alt="...">
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card">
                                        <img src="<?php echo base_url(); ?>/assets/img/img-02.jpg" class="card-img-top"
                                            alt="...">
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card">
                                        <img src="<?php echo base_url(); ?>/assets/img/img-03.jpg" class="card-img-top"
                                            alt="...">
                                        <div class="card-body">
                                            <h6 class="card-title fw-semibold">Most tropical areas are suitable</h6>
                                            <p class="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be
                                ...
                                <div class="col">
                                    <div class="card">
                                        <img src="<?php echo base_url(); ?>/assets/img/img-04.jpg" class="card-img-top"
                                            alt="...">
                                        <div class="card-body">
