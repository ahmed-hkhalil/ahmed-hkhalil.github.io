														...
														<table class="table  datanew">
															...
															<tbody>
																<tr>
																	...
																	<td>
																		<div class="language-name d-flex align-items-center">
																			<img src="<?php echo base_url();?>assets/img/icons/flag-01.svg" class="me-2" alt="">
																			English
																		</div>
																	</td>
																	<td>
																	...
																	<td class="action-table-data">
																		<div class="edit-delete-action language-action">
																			...
																			<a href="<?php echo base_url();?>language-settings-web" class="btn btn-secondary me-2">Web</a>
																...
																<tr>
																	...
																	<td>
																		<div class="language-name d-flex align-items-center">
																			<img src="<?php echo base_url();?>assets/img/icons/flag-02.svg" class="me-2" alt="">
																			Arabic
																		</div>
																	</td>
																	<td>
																...
																<tr>
																	...
																	<td>
																		<div class="language-name d-flex align-items-center">
																			<img src="<?php echo base_url();?>assets/img/icons/flag-03.svg" class="me-2" alt="">
																			Chinese
																		</div>
																	</td>
																	<td>
																...
																<tr>
																	...
																	<td>
																		<div class="language-name d-flex align-items-center">
																			<img src="<?php echo base_url();?>assets/img/icons/flag-04.svg" class="me-2" alt="">
																			Hindi
																		</div>
																	</td>
																	<td>
