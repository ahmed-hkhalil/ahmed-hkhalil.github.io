        ...
        <div class="main-wrapper">
            <div class="account-content">
                        <div class="login-wrapper">
                            <div class="login-content">
                                <form action="<?php echo base_url(); ?>dashboard">
                                    ...
                                    <div class="form-login authentication-check">
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-end">
                                                <a class="forgot-link" href="<?php echo base_url(); ?>forgot-password-2">Forgot Password?</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-login">
                                    ...
                                    <div class="signinform">
                                        <h4>New on our platform?<a href="<?php echo base_url(); ?>register-2" class="hover-a"> Create an account</a></h4>
                                    </div>
                            ...
                            <div class="login-img">
                                <img src="<?php echo base_url(); ?>/assets/img/authentication/login02.png" alt="img">
                            </div>
                        </div>
            </div>
        </div>
