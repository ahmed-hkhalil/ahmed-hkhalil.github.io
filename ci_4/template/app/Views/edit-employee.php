				...
				<div class="content">
					<div class="page-header">
						...
						<ul class="table-top-head">
							<li>
								<div class="page-btn">
									<a href="<?php echo base_url();?>employees-list" class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Employee List</a>
								</div>
							</li>
							<li>
					...
					<div class="card">
						<div class="card-body">
							<form action="<?php echo base_url();?>edit-employee">
								<div class="new-employee-field">
									...
									<div class="profile-pic-upload edit-pic">
										<div class="profile-pic">
											<span><img src="<?php echo base_url();?>assets/img/users/user-01.jpg" alt=""></span>
										</div>
										<div class="me-3 mb-0">
