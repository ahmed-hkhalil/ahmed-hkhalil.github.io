            ...
            <div class="page-wrapper">
				<div class="content">
					<div class="page-header">
						...
						<div class="page-btn">
							<a href="<?php echo base_url();?>add-employee" class="btn btn-added"><i data-feather="plus-circle" class="me-2"></i>Add New Employee</a>
						</div>
					</div>
					<!-- /product list -->
					<div class="card">
							...
							<div class="table-top table-top-two table-top-new">
								...
								<div class="search-path d-flex align-items-center search-path-new">
									<div class="d-flex">
										...
										<a href="<?php echo base_url();?>employees-list" class="btn-list"><i data-feather="list" class="feather-user"></i></a>
										<a href="<?php echo base_url();?>employees-grid" class="btn-grid active"><i data-feather="grid" class="feather-user"></i></a>
									</div>
										...
										<div class="profile-head-action">
											...
											<div class="dropdown profile-action">
												...
												<ul class="dropdown-menu">
													<li>
														<a href="<?php echo base_url();?>edit-employee" class="dropdown-item"><i data-feather="edit" class="info-img"></i>Edit</a>
													</li>
													<li>
