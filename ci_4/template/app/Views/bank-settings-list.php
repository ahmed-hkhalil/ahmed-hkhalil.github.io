                             ...
                             <?= $this->include('partials/settings-sidebar') ?>
								<div class="settings-page-wrap w-50">
									...
									<div class="page-header bank-settings justify-content-end">
										<a href="<?php echo base_url(); ?>bank-settings-list" class="btn-list me-2 active"><i data-feather="list" class="feather-user"></i></a>
										<a href="<?php echo base_url(); ?>bank-settings-grid" class="btn-grid"><i data-feather="grid" class="feather-user"></i></a>
										<div class="page-btn">
					...
					<div class="page-wrapper-new p-0">
						<div class="content">
							...
							<div class="modal-body custom-modal-body">
								<form action="<?php echo base_url(); ?>bank-settings-list">
									<div class="row">
										<div class="col-lg-12">
											<div class="mb-3">
