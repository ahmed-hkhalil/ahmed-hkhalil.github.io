                             ...
                             <?= $this->include('partials/settings-sidebar') ?>
								<div class="settings-page-wrap w-50">
									...
									<div class="page-header">
										<div class="back-btn">
											<a href="<?php echo base_url();?>language-settings" class="btn btn-translation"><i data-feather="arrow-left" class="filter-icon me-2"></i>Back to Translations </a>
										</div>
										<div class="page-btn">
											<a href="javascript:void(0);" class="d-flex align-items-center selected-language"><img src="<?php echo base_url();?>assets/img/icons/flag-02.svg" class="me-2" alt="">Arabic</a>
										</div>
									</div>
									<div class="row">
										<div class="col-lg-12">
							...
							<div class="page-header justify-content-between">
								<div class="page-title d-flex align-items-center">
									<div class="page-btn mt-0">
										<a href="javascript:void(0);" class="d-flex align-items-center selected-language me-3"><img src="<?php echo base_url();?>assets/img/icons/flag-02.svg" class="me-2" alt="">Arabic</a>
									</div>
									<div class="position-relative">
