...
setTimeout(function () {
    $('.main-wrapper').append('<div class="sidebar-settings nav-toggle" id="layoutDiv">' +
        ...
        '<a href="../../template/public/dashboard"><img src="assets/img/theme/theme-img-01.jpg" alt=""></a>' +
        ...
        '<a href="../../template-rtl/public/dashboard" target="_blank"><img src="assets/img/theme/theme-img-03.jpg" alt=""></a>' +
