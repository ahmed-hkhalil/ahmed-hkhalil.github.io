      ...
      <div className="content">
        <div className="page-header page-add-notes">
          ...
          <div className="d-flex flex-sm-row flex-column align-items-sm-center align-items-start">
            ...
            <ul className="table-top-head me-3">
              <li>
            ...
            <div className="page-btn">
              ...
              >
                <PlusCircle className="ms-2" /> Add Task{" "}
              </Link>
            </div>
          </div>
        </div>
              ...
              <div className="notes-top-head-submenu">
                ...
                >
                  ...
                  >
                    ...
                    Inbox <span className="me-2">1</span>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <i
                      ...
                      className="feather-check-circle ms-2"
                    />
                    Done
                  </button>
                  <button
                  ...
                  >
                    {" "}
                    <i data-feather="star" className="feather-star ms-2" />
                    Important
                  </button>
                  <button
                  ...
                  >
                    ...
                    <i
                      ...
                      className="feather-trash-2 ms-2"
                    />
                    Trash
                  </button>
                </div>
